...
Patch release updating Rust dependencies and CI actions.

### Changed

- Updated `stillwater` to 1.1 and refreshed the locked versions of `phonenumber`, `regex`, `serde`, `serde_json`, `tokio`, and `uuid`.
...
- Regenerated `Cargo.lock` with the latest Rust 1.89-compatible dependency set.
- Updated GitHub Actions artifact upload dependency in CI workflows.
...
[0.2.2]: https://github.com/iepathos/stilltypes/releases/tag/v0.2.2
[0.2.1]: https://github.com/iepathos/stilltypes/releases/tag/v0.2.1
