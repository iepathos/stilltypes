...
coverage:
    ...
    cargo llvm-cov nextest --all-features --lib --html --output-dir target/coverage
...
coverage-lcov:
    ...
    cargo llvm-cov nextest --all-features --lib --lcov --output-path target/coverage/lcov.info
...
coverage-check:
    ...
    cargo llvm-cov clean
    mkdir -p target/coverage
    cargo llvm-cov nextest --all-features --lib --json --output-path target/coverage/coverage.json
